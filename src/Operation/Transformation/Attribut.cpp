...
void Attribut::set_colorRGB(Subset* subset){
...
void Attribut::set_colorI(Subset* subset){
  vector<vec4>& RGB_obj = subset->RGB;
  vector<float>& Is = subset->I;
  //---------------------------
...
void Attribut::set_enhancedColor(Subset* subset){
  vector<float>& Is = subset->I;
...
void Attribut::set_randomizeAllPointsColor(Subset* subset){
  vector<vec4>& RGB = subset->RGB;
  //---------------------------
...
void Attribut::set_restoreInitialColor(Subset* subset){
  vector<vec4>& RGB_o = subset->RGB;
  const vector<vec4>& RGB_i = subset->RGB;
  //---------------------------

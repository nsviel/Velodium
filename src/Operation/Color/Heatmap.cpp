...
void Heatmap::mode_height(Subset* subset){
  ...
  //---------------------------
  this->set_heatmap(subset, color_vec);
}
...
void Heatmap::set_heatmap(Subset* subset, vector<float>& v_in){
...
void Heatmap::unset_heatmap(Subset* subset){

...
void Parser_Scala::parse_blocks(){
  packet_A.clear();
  packet_R.clear();
  packet_I.clear();
  //---------------------------
...
void Parser_Scala::parse_azimuth(){
  //---------------------------
...
void Parser_Scala::parse_coordinates(){
  packet_xyz.clear();
  //---------------------------
...
void Parser_Scala::parse_timestamp(){
  packet_t.clear();
  //---------------------------
...
//Subsubfunctions
vector<float> Parser_Scala::calc_timing_offsets(){
...
void Parser_Scala::make_supressElements(vector<vec3>& vec, vector<int> idx){
...
void Parser_Scala::make_supressElements(vector<float>& vec, vector<int> idx){
  if(idx.size() == 0)return;
  //---------------------------
